...
- The parser supports declared local schemas and named struct schemas in [rustscript/src/compiler/parser/statements.rs](../rustscript/src/compiler/parser/statements.rs), but every non-primitive type name is currently treated as either a struct schema reference or an error.
- Struct schemas are currently stored as `HashMap<String, TypeSchema>` in [rustscript/src/compiler/ir.rs](../rustscript/src/compiler/ir.rs), which is sufficient for concrete structs but not for `struct Box<T> { ... }` plus `Box<string>`.
- Function declarations only carry `name`, `arity`, `args`, `exported`, and coarse `return_type` in [rustscript/src/compiler/ir.rs](../rustscript/src/compiler/ir.rs), so parameter schema annotations such as `v: T` are not yet represented.
- Call expressions do not carry explicit type arguments in [rustscript/src/compiler/ir.rs](../rustscript/src/compiler/ir.rs).
- The analyzer already propagates call-site information into RSS function bodies in [rustscript/src/compiler/typing/context.rs](../rustscript/src/compiler/typing/context.rs), but its observation maps are keyed only by function index, so different generic instantiations would currently collapse together.
...
- Host functions already expose coarse return types and parameter signatures through [rustscript/src/compiler/parser/symbols.rs](../rustscript/src/compiler/parser/symbols.rs), [rustscript/src/compiler/typing/helpers.rs](../rustscript/src/compiler/typing/helpers.rs), [rustscript/src/builtins/metadata.rs](../rustscript/src/builtins/metadata.rs), and [rustscript/build.rs](../rustscript/build.rs), but they do not expose generic metadata or return-schema templates.
...
- [rustscript/src/compiler/ir.rs](../rustscript/src/compiler/ir.rs)
- [rustscript/src/compiler/parser/mod.rs](../rustscript/src/compiler/parser/mod.rs)
- [rustscript/src/compiler/parser/cursor.rs](../rustscript/src/compiler/parser/cursor.rs)
- [rustscript/src/compiler/parser/statements.rs](../rustscript/src/compiler/parser/statements.rs)
- [rustscript/src/compiler/parser/expressions.rs](../rustscript/src/compiler/parser/expressions.rs)
- [rustscript/src/compiler/linker.rs](../rustscript/src/compiler/linker.rs)
...
2. Add explicit generic struct declaration metadata in [rustscript/src/compiler/ir.rs](../rustscript/src/compiler/ir.rs).
...
11. Update linker merge logic in [rustscript/src/compiler/linker.rs](../rustscript/src/compiler/linker.rs) so it preserves and validates generic structs and generic functions when imported modules are merged.
...
- [rustscript/src/compiler/typing/context.rs](../rustscript/src/compiler/typing/context.rs)
- [rustscript/src/compiler/typing/helpers.rs](../rustscript/src/compiler/typing/helpers.rs)
- [rustscript/src/compiler/typing/state.rs](../rustscript/src/compiler/typing/state.rs)
...
5. Update schema mismatch logic in [rustscript/src/compiler/typing/helpers.rs](../rustscript/src/compiler/typing/helpers.rs) so:
...
- [rustscript/src/compiler/typing/context.rs](../rustscript/src/compiler/typing/context.rs)
- [rustscript/src/compiler/typing/collect.rs](../rustscript/src/compiler/typing/collect.rs)
- [rustscript/src/compiler/typing/helpers.rs](../rustscript/src/compiler/typing/helpers.rs)
- [rustscript/src/compiler/typing.rs](../rustscript/src/compiler/typing.rs)
...
- [rustscript/src/compiler/typing/context.rs](../rustscript/src/compiler/typing/context.rs)
- [rustscript/src/compiler/typing/helpers.rs](../rustscript/src/compiler/typing/helpers.rs)
- [rustscript/src/compiler/pipeline.rs](../rustscript/src/compiler/pipeline.rs)
...
- [rustscript/src/builtins/metadata.rs](../rustscript/src/builtins/metadata.rs)
- [rustscript/build.rs](../rustscript/build.rs)
...
- [rustscript/tests/compiler/type_inference_tests.rs](../rustscript/tests/compiler/type_inference_tests.rs)
- [rustscript/tests/compiler/compiler_rustscript_tests.rs](../rustscript/tests/compiler/compiler_rustscript_tests.rs)
- [rustscript/tests/compiler/diagnostics_tests.rs](../rustscript/tests/compiler/diagnostics_tests.rs)
